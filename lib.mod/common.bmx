...
Extern
	...
	Function bmx_raylib_DrawRing(center:RVector2, innerRadius:Float, outerRadius:Float, startAngle:Float, endAngle:Float, segments:Int, color:RColor)="DrawRing"
	Function bmx_raylib_DrawRingLines(center:RVector2, innerRadius:Float, outerRadius:Float, startAngle:Float, endAngle:Float, segments:Int, color:RColor)="DrawRingLines"
	...
	Function bmx_raylib_DrawRectangleRoundedLines(rec:RRectangle, roundness:Float, segments:Int, color:RColor)="DrawRectangleRoundedLines"
	Function bmx_raylib_DrawRectangleRoundedLinesEx(rec:RRectangle, roundness:Float, segments:Int, lineThick:Float, color:RColor)="DrawRectangleRoundedLinesEx"
...
'	Function bmx_raylib_GetRandomValue:Int(minimum:Int, maximum:Int)="GetRandomValue"
	...
	Function bmx_raylib_LoadFontData:RGlyphInfo Ptr(fileData:Byte Ptr, dataSize:Int, fontSize:Int, codepoints:Int Ptr, codepointCount:Int, fontType:Int)="LoadFontData"
